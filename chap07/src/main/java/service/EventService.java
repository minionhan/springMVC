...
@Component
public class EventService {//injectiond을 하지 않는다.
	private SortedMap<Long, Event> eventMap = new TreeMap<>();
	public EventService(){
		eventMap.put(1L, Event.create(1L, "JCO 객체 지향 발들기", EventType.CONFERENCE));
		...
		eventMap.put(6L, Event.create(6L, "동준 서커스", EventType.CIRCUS));
	}
